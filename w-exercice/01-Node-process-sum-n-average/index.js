...
function calculating(){
    ...
    if(sign !="sum" && sign != "avg" && sign !="med") result = "I cannot calculate that, please type either 'sum' (to calculate the sum), 'avg' (To calculate the Average) or 'med'(To calculate the median)";
     if(string.length !== 0){
